...
provides:
  - bin/${MOUNTIN_TARGET_PLATFORM}/dmake
  - bin/${MOUNTIN_TARGET_PLATFORM}/lib/libmakestate.so.1
  - bin/${MOUNTIN_TARGET_PLATFORM}/lib/64/libmakestate.so.1
  - bin/${MOUNTIN_TARGET_PLATFORM}/lib/64/libelf.so.1
---
