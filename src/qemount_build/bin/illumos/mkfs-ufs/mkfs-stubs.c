...
offset_t
qemount_llseek(int descriptor, offset_t offset, int whence)
{
...
int
qemount_aiowrite(int descriptor, caddr_t buffer, int size, off_t offset,
...
aio_result_t *
qemount_aiowait(struct timeval *timeout)
{
