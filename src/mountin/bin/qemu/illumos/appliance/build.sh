...
install -m 0755 /host/build/bin/${MOUNTIN_TARGET_PLATFORM}/mountin-bootstrap \
    "$staging/sbin/init"
install -m 0755 /host/build/bin/${MOUNTIN_TARGET_PLATFORM}/mountin-init \
    "$staging/sbin/mountin-init"
install -m 0755 /host/build/bin/${MOUNTIN_TARGET_PLATFORM}/9d \
    "$staging/sbin/9d"
