...
sfdisk "$OUTPUT" << EOF
label: gpt
start=$P0_START, size=$P0_SIZE, type=EBD0A0A2-B9E5-4433-87C0-68B6B72699C7, name=fat32
start=$P1_START, size=$P1_SIZE, type=0FC63DAF-8483-4772-8E79-3D69D8477DE4, name=ext2
start=$P2_START, size=$P2_SIZE, type=0FC63DAF-8483-4772-8E79-3D69D8477DE4, name=ext3
start=$P3_START, size=$P3_SIZE, type=0FC63DAF-8483-4772-8E79-3D69D8477DE4, name=ext4
start=$P4_START, size=$P4_SIZE, type=0FC63DAF-8483-4772-8E79-3D69D8477DE4, name=xfs
start=$P5_START, size=$P5_SIZE, type=0FC63DAF-8483-4772-8E79-3D69D8477DE4, name=btrfs
EOF
