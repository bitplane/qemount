...
| Partition Table    | Linux 6.12 | Linux 2.6 | NetBSD 10 | DragonFly 6.4 | AROS i386 | Haiku x86_64 | PureDarwin 17.4 | 9front | illumos x86_64 | Notes                           |
| ------------------ | ---------- | --------- | --------- | ------------- | --------- | ------------ | ----------------- | ------ | --------------- | ------------------------------- |
| **MBR/DOS**        | ✅         | ✅        | ✅        | ✅            | ✅        | ✅           | ✅                | ✅     | ✅             |                                 |
| **GPT**            | ✅         | ✅        | ✅        | ✅            | ✅        | ✅           | ✅                | ❌     | ✅             |                                 |
...
| Filesystem      | Linux 6.12 | Linux 2.6 | NetBSD 10 | DragonFly 6.4 | AROS      | Haiku x86_64 | PureDarwin 17.4 | 9front | illumos x86_64 | Notes                                  |
| --------------- | ---------- | --------- | --------- | ------------- | --------- | ------------ | ----------------- | ------ | --------------- | -------------------------------------- |
| **ext2**        | ✅         | ✅        | ✅        | ✅            | ❌        | ✅           | ❌                | ❌     | ❌             |                                        |
...
| **UFS/FFS**     | 💩         | 💩        | ✅        | ✅ UFS1       | ❌        | ❌           | ❌                | ❌     | ✅ UFS1        | Linux UFS is limited                   |
