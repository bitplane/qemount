...
title: Qemount
env:
  QEMOUNT_CACHE_DIR: ${QEMOUNT_CACHE_DIR}
  CARGO_HOME: /host/build/cache/cargo
  CARGO_TARGET_DIR: ${QEMOUNT_CACHE_DIR}/cargo-target
...
# Qemount Catalogue Root

Every provider instance receives a stable private build cache at
`QEMOUNT_CACHE_DIR`. The build system derives the directory from the build
