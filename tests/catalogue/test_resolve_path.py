...
def test_resolve_path_different_arch():
    ...
    meta_x86 = resolve_path("child/leaf", cat, {"BUILD_ARCH": "x86_64", "TARGET_ARCH": "x86_64"})
    meta_arm = resolve_path("child/leaf", cat, {"BUILD_ARCH": "aarch64", "TARGET_ARCH": "aarch64"})
